                ...
                <div className="grid-container">
                    ...
                    <div className="grid">
                        ...
                        <div className="grid-item">
                            <Card
                                image="/Serene-Hearts-AFH/images/teeth.jpg"
                        ...
                        <div className="grid-item">
                            <Card
                                image="/Serene-Hearts-AFH/images/food.jpg"
                        ...
                        <div className="grid-item">
                            <Card
                                image="/Serene-Hearts-AFH/images/activity.jpg"
                        ...
                        <div className="grid-item">
                            <Card
                                image="/Serene-Hearts-AFH/images/care.png"
                        ...
                        <div className="grid-item">
                            <Card
                                image="/Serene-Hearts-AFH/images/laundry.png"
                        ...
                        <div className="grid-item">
                            <Card
                                image="/Serene-Hearts-AFH/images/transport.jpg"
